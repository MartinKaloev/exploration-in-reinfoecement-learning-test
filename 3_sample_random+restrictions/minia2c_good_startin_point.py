...
def main():
    ...
    for episode in range(train_episodes):
        ...
        while not done:
            ...
            #print(np.around(observation, 2)[2])
            #print (np.around(observation, 2)[2])
            if np.around(observation, 2)[2] > 0.17:
                action = 1
                #print(action)
                #print("break")
            else:
            ...
            print("Obs position: ", np.around(next_observation, 2)[0],"Obs velocity: ",  np.around(next_observation, 2)[1],"Obs angle: ",  np.around(next_observation, 2)[2],"Obs Pole Angular Velocity : ",  np.around(next_observation, 2)[3], "action: ", np.around(action) )
            ...
            if total_training_rewards > 60 or episode == 100:
