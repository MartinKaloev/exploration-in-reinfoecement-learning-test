...
def main():
    ...
    if os.path.exists('training_actor_'):
        ...
        critic2.load_weights(critic_checkpoint_path_)
        print("teacher ANN loaded sucsefully")
    else:
        print("test unvavilid no loaded teacher ANN ")
        sys.exit()
    ...
    rewards_=[]
    rewards_2=[]
    test_duration=input("episode to be lead by teacher: (number 10 or 60)")
