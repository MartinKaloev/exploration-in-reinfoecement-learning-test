...
def main():
    actor_checkpoint_path = "training_actor2/actor_cp.ckpt"
    critic_checkpoint_path = "training_critic2/critic_cp.ckpt"
    ...
    for episode in range(train_episodes):
        ...
        while not done:
            ...
            if done:
                ...
                rewards_T.append(total_training_rewards)
            if total_training_rewards > 160 or episode == 260:
                ...
                plts(rewards_T,"Rewards per episode", "Rewards")
                sys.exit()
